...
class JJEncode_project_parse:
    def __init__(self):
		...
		"Cookie":"session=c2fd97cc-6298-4c9b-b381-b25192c14097.4vyZApj_c5NfL7g_nYvenNbFo34;__guid=170017250.164682424875080800.1611363477127.7908;monitor_count=93",
    ...
    def read_js_content(self):
        with open('./卍络者第三题-AAEncode加密.js','r',encoding='utf-8') as file:
            content = file.read()
        return content
    def get_sum(self):
